                ...
                <div class="p-5 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font overflow-hidden">
                        <div class="container mx-auto">
                            <div class="mx-auto flex flex-wrap">
                                ...
                                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                    ...
                                    <form method="post" action="{{ route('user.cart.add') }}">
                                        @csrf
                                        <div class="flex mt-6 ml-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <button class="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">カート追加</button>
                            ...
                            <div class="text-center text-lg title-font mb-4">この商品を販売しているショップ</div>
                            <div class="text-center text-lg mb-4">{{ $product->shop->name }}</div>
                            ...
                            <div class="text-center text-lg mb-4">
                                <button data-micromodal-trigger="modal-1" type="button" class="text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">ショップを見る</button>
                            </div>
                        </div>
                    </section>
                </div>
